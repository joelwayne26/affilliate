...
// 3. Fill in: name, description, link (your affiliate URL), etc.
...
export const niches: Niche[] = [
  // ┌─────────────────────────────────────────────────────────┐
  // │  NICHE 1: HOME & LIVING (FAST — Amazon + ShareASale)   │
  // └─────────────────────────────────────────────────────────┘
  {
    id: "home-living",
    title: "Home & Living",
    ...
    products: [
      {
        ...
        description: "The #1 best-selling multi-cooker that replaces 9 appliances. Pressure cook, slow cook, sauté, steam, and more — perfect for busy households.",
        bestFor: "Busy families & meal preppers",
        link: "https://amazon.com/dp/B07W55D31W?tag=YOURTAG-20", // ← Replace YOURTAG-20
        program: "amazon",
        commission: "4.5%",
        rating: 4.8,
        tag: "Best Seller",
      ...
      },
      {
        ...
        link: "https://www.shareasale.com/r.cfm?b=XXXX&u=YOURID&m=XXXX", // ← Replace IDs
        program: "shareasale",
        commission: "5-7%",
        rating: 4.4,
        tag: "Huge Selection",
  ...
  // ┌─────────────────────────────────────────────────────────┐
  // │  NICHE 2: HEALTH & WELLNESS (FAST — ClickBank + Amazon)│
  // └─────────────────────────────────────────────────────────┘
  {
    id: "health-wellness",
    ...
    products: [
      {
        ...
        link: "https://YOURCLICKBANKID.smoothdie.hop.clickbank.net", // ← Replace
        program: "clickbank",
        commission: "75%",
        rating: 4.3,
        tag: "Top Earner",
  ...
  // ┌─────────────────────────────────────────────────────────┐
  // │  NICHE 3: MONEY & FINANCE (MEDIUM — ShareASale + CB)   │
  // └─────────────────────────────────────────────────────────┘
  {
    id: "money-finance",
    title: "Money & Finance",
    ...
    products: [
      {
        ...
        link: "https://www.shareasale.com/r.cfm?b=XXXX&u=YOURID&m=XXXX", // ← Replace
        program: "shareasale",
        commission: "$200/sale",
        rating: 4.8,
        tag: "Top Earner",
  ...
  // ┌─────────────────────────────────────────────────────────┐
  // │  NICHE 4: E-COMMERCE TOOLS (LONG — Shopify)            │
  // └─────────────────────────────────────────────────────────┘
  {
    id: "ecommerce-tools",
    ...
    products: [
      {
        ...
        link: "https://shopify.pxf.io/YOURID", // ← Replace
        program: "shopify",
  ...
  // ┌─────────────────────────────────────────────────────────┐
  // │  NICHE 5: DIGITAL TOOLS (LONG — Amazon + ShareASale)   │
  // └─────────────────────────────────────────────────────────┘
  {
    id: "digital-tools",
    title: "Digital Tools",
